...
class TransformerModelv14(nn.Module): # takes in images, embeds, performs self-attention, and decodes to image
    def __init__(self, embed_dim=768, grid_size = 3, num_heads=32, \
                 mlp_ratio=4.,norm_layer=nn.LayerNorm, depth = 4, cat=False):
        super(TransformerModelv14, self).__init__()
...
class TransformerModelv13(nn.Module): # takes in images, embeds, performs self-attention, and decodes to image
    def __init__(self, embed_dim=768, grid_size = 3, num_heads=32, \
                 mlp_ratio=4.,norm_layer=nn.LayerNorm, depth = 4, cat=False):
        super(TransformerModelv13, self).__init__()
    ...
    def forward(self, ims):
        ...
        guess = self.mlp1(self.flatten(x))
...
class TransformerModelv12(nn.Module): # takes in images, embeds, performs self-attention, and decodes to image
    def __init__(self, embed_dim=768, grid_size = 3, num_heads=32, \
                 mlp_ratio=4.,norm_layer=nn.LayerNorm, depth = 4, cat=False):
        super(TransformerModelv12, self).__init__()
    ...
    def forward(self, ims):
        ...
        guess = self.decoder.forward(x).view(batch_size, 1, 160, 160) # create images
...
class TransformerModelv11(nn.Module): # takes in images, embeds, performs self-attention, and decodes to image
    def __init__(self, embed_dim=768, grid_size = 3, num_heads=32, \
                 mlp_ratio=4.,norm_layer=nn.LayerNorm, depth = 4, cat=False):
        super(TransformerModelv11, self).__init__()
