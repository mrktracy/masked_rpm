...
logfile = "../../tr_results/v17_itr2_full_actual/runlog.txt"
...
def main_BERT():
    ...
    transformer_model = TransformerModelv17(embed_dim = 768, symbol_factor=3, depth=5, num_heads=64, cat_pos=True, \
