...
logfile = "../../tr_results/v17_itr3_full/runlog.txt"
...
def main_BERT():
    ...
    transformer_model = TransformerModelv17(embed_dim = 768, symbol_factor=2, depth=8, num_heads=64, cat_pos=True, \
