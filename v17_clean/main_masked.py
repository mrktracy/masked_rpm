...
logfile = "../../tr_results/v17-itr0_full_100/runlog.txt"
...
def main_BERT():
    ...
    transformer_model = TransformerModelv17(embed_dim = 192, symbol_factor=3, depth=5, num_heads=32, cat_pos=True, \
