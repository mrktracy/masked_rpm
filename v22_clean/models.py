    ...
    def __init__(self,
        ...
        if self.use_backbone_enc:
            if restrict_qk:
                ...
                self.perception = BackbonePerceptionOld(embed_dim=self.embed_dim, depth=self.bb_depth,
    ...
    def __init__(self,
        ...
        self.blocks = nn.ModuleList([
            Block(self.out_channels, self.out_channels, self.num_heads, self.mlp_ratio,
                  q_bias=False, k_bias=False, v_bias=False, norm_layer=norm_layer, proj_drop=0.5, attn_drop=0.5,
