...
from models import TransformerModelv15, TransformerModelv16
import os
import logging

logfile = "../../tr_results/v16-itr0/runlog.txt"
...
def main_BERT():
    ...
    transformer_model = TransformerModelv16(symbol_factor=2, depth=5, num_heads=64, cat=True).to(device)
