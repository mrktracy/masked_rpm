...
logfile = "../tr_results/v11-itr12/runlog.txt"
...
def main_BERT():
    ...
    transformer_model = TransformerModelv11(depth=20, num_heads=64, cat=True).to(device)
    ...
    ALPHA_2 = 0.9 # for relative importance of guess vs. autoencoder accuracy
